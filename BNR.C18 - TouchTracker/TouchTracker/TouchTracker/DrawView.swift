...
//  TouchTracker
//
//  Created by Charles Nolan on 3/15/18.
...
//        UIColor.red.setStroke()
    ...
    func indexOfLines(at point: CGPoint) -> Int? {
    ...
    //MARK: - Tap Gesture Recognizer Features
    ...
    @objc func tap(_ gestureRecognizer: UIGestureRecognizer) {
        ...
        selectedLineIndex = indexOfLines(at: point)
